...
local Text = {
    ...
    [10084] = {zh_cn = "排行榜", en_us = "排行榜"},
    [10085] = {zh_cn = "总航行距离", en_us = "总航行距离"},
    [10086] = {zh_cn = "单次航行距离", en_us = "单次航行距离"},
    [10087] = {zh_cn = "单次航行天数", en_us = "单次航行天数"},
    [10088] = {zh_cn = "未上榜", en_us = "未上榜"},
    [10089] = {zh_cn = "我的排名: ", en_us = "我的排名: "},
    [10090] = {zh_cn = "总航行天数", en_us = "总航行天数"},
    [10091] = {zh_cn = "排名", en_us = "排名"},
    [10092] = {zh_cn = "商城", en_us = "商城"},
    [10093] = {zh_cn = "购买", en_us = "购买"},
    [10094] = {zh_cn = "原地复活成功", en_us = "原地复活成功"},
    [10095] = {zh_cn = "购买复活失败: %s", en_us = "购买复活失败: %s"},
    [10096] = {zh_cn = "你需要原地复活吗？", en_us = "你需要原地复活吗？"},
    [10097] = {zh_cn = "消耗69 Robux原地复活", en_us = "消耗69 Robux原地复活"},
    [10098] = {zh_cn = "回主城复活", en_us = "回主城复活"},
}
