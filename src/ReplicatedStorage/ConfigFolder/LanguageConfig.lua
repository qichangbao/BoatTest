...
local Text = {
    ...
    [10086] = {zh_cn = "单次最大距离", en_us = "单次最大距离"},
    [10087] = {zh_cn = "航行天数", en_us = "航行天数"},
    [10088] = {zh_cn = "未上榜", en_us = "未上榜"},
    [10089] = {zh_cn = "我的数据: 总距离 %.1f 米 | 最大单次 %.1f 米 | 航行天数 %.2f 天 | 总排名 %s | 单次排名 %s | 天数排名 %s", en_us = "我的数据: 总距离 %.1f 米 | 最大单次 %.1f 米 | 航行天数 %.2f 天 | 总排名 %s | 单次排名 %s | 天数排名 %s"},
}
