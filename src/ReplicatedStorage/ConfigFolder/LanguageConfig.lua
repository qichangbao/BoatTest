...
local Text = {
    ...
    [10099] = {zh_cn = "创建船只", en_us = "创建船只"},
    [10100] = {zh_cn = "没有船身", en_us = "没有船身"},
    [10101] = {zh_cn = "打开宝箱", en_us = "打开宝箱"},
    [10102] = {zh_cn = "宝箱", en_us = "宝箱"},
    [10103] = {zh_cn = "即将沉没", en_us = "即将沉没"},
    [10104] = {zh_cn = "岛屿沉没剩余时间: %s", en_us = "岛屿沉没剩余时间: %s"},
    [10105] = {zh_cn = "运气太衰，没有抽中物品", en_us = "运气太衰，没有抽中物品"},
    [10106] = {zh_cn = "反馈", en_us = "反馈"},
    [10107] = {zh_cn = "请在此输入你的反馈内容...", en_us = "请在此输入你的反馈内容"},
    [10108] = {zh_cn = "反馈已提交", en_us = "反馈已提交"},
    [10109] = {zh_cn = "感谢你的反馈！已同时提交到游戏分析和Roblox官方反馈系统", en_us = "感谢你的反馈！已同时提交到游戏分析和Roblox官方反馈系统"},
    [10110] = {zh_cn = "反馈提交失败", en_us = "反馈提交失败"},
    [10111] = {zh_cn = "你的反馈未成功提交到游戏分析，请稍后重试。", en_us = "你的反馈未成功提交到游戏分析，请稍后重试。"},
}
